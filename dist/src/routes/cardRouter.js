...
import { activateCard, blockCard, createCard, getTransactions, unblockCard, } from "../controllers/cardController.js";
...
cardRouter.post("/cards", APIKeyValidator, schemaValidator(createSchema), createCard);
cardRouter.put("/cards/activate/:id", schemaValidator(activateSchema), activateCard);
...
cardRouter.post("/card/unblock/:id", schemaValidator(passwordSchema), unblockCard);
